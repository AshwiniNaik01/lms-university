...
// const FeedbackTab = ({ batch }) => {
//   const feedbackForm = batch.feedbacks?.[0];
...
//                         responses[q] === emojiToValue[option.label] ? "border-2 border-blue-600 shadow-lg" : "border-transparent"
//                       }`}
//                     >
...
//               <h3 className="text-xl font-semibold text-gray-700">No Feedback Questions Available</h3>
...
//                     if (num <= 6) {
//                       bgColor = "bg-gradient-to-b from-rose-500 to-rose-600";
//                       textColor = "text-red-600";
//                     } else if (num <= 8) {
//                       bgColor = "bg-gradient-to-b from-yellow-500 to-yellow-600";
//                       textColor = "text-yellow-600";
//                     } else {
//                       bgColor = "bg-gradient-to-b from-emerald-500 to-emerald-600";
...
//                             ${responses[npsQuestion] === num ? "scale-140 shadow-2xl" : "group-hover:scale-110"}`}
//                         >
//                           {num}
//                         </button>
...
//   <div className="relative">
//     {/* <div className="h-3 bg-gray-300 rounded-full mb-12"></div> */}
//     <div className="flex justify-between relative">
//       {[...Array(11).keys()].map((num) => {
//         let isFilled = responses[npsQuestion] >= num; // fill all buttons <= selected
//         let bgColor = isFilled
//           ? num <= 6
