...
const MeetingsDropdown = ({ batch, onClose }) => {
  ...
  return createPortal(
    <>
      ...
      {/* DROPDOWN / MODAL */}
      <div className="fixed top-24 left-1/2 -translate-x-1/2 w-[90vw] max-w-6xl mt-7 bg-white shadow-2xl rounded-lg border border-gray-200 overflow-hidden z-50 animate-fadeIn">
