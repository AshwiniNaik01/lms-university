...
const UploadEnrollmentExcel = () => {
  ...
  //   if (!file) {
  //     return Swal.fire("Error", "Please upload a file", "error");
  //   }

  //   // GET COURSES (which already include batches)
  //   const courseResponse = await getAllCourses();
  //   const courses = courseResponse; // array of training programs
  ...
  //       if (!selectedCourse || !selectedCourse.batches || selectedCourse.batches.length === 0) {
  //         batchSelect.innerHTML = `<option value="">No batches available</option>`;
  //         return;
  //       }

  //       // Populate batches with nice styling
  //       batchSelect.innerHTML += selectedCourse.batches
  //         .map(
  //           (b) => `<option value="${b._id}">${b.batchName}</option>`
  //         )
  //         .join("");
  //     });
  //   },
  ...
  //     confirmButton: 'bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg shadow-md',
  //     cancelButton: 'bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded-lg shadow-md'
  //   },
  //   preConfirm: () => {
  ...
  //       Swal.showValidationMessage("Please select both Training Program and Batch");
  //     }
  ...
  //   formData.append("enrolledCourses", formValues.trainingProgramId);
  //   formData.append("enrolledBatches", formValues.batchId);

  //   try {
  //     const res = await apiClient.post("/api/enrollments/upload", formData, {
  ...
  //   // STEP 2 — Ask for Training Program + Batch
  //   const courseResponse = await getAllCourses();
  //   const courses = courseResponse; // array of training programs
  ...
  //   // STEP 3 — Submit the file with selected course & batch
  //   const formData = new FormData();
  //   formData.append("excelFile", file);
  //   formData.append("enrolledCourses", formValues.trainingProgramId);
  //   formData.append("enrolledBatches", formValues.batchId);
