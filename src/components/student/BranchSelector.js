...
import { fetchUserProfile, updateUserProfileApi } from "../../api/profile.js"; // Assuming profile API can update branch
...
const BranchSelector = () => {
    ...
    try {
      ...
      setError(
        err.response?.data?.message ||
          "An error occurred while updating your branch."
      );
    }
    setLoading(false);
  };
  ...
  return (
    <div className="container" style={{ maxWidth: "600px" }}>
      ...
      <p>
        Your current branch: <strong>{currentBranchName}</strong>
      </p>
