...
import {    FaUser, FaGraduationCap, FaBriefcase, FaMapMarkerAlt, FaFileAlt, FaCertificate, FaTrophy, FaCode, FaLinkedin, FaCalendar } from 'react-icons/fa';
      ...
      <form onSubmit={formik.handleSubmit} className="space-y-0">
        ...
        <div className="p-8 border-b border-blue-100">
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              ...
              <p className="text-gray-600">Teaching and industry experience</p>
            </div>
          </div>
        ...
        <div className="p-8 border-b border-blue-100 bg-gradient-to-r from-emerald-50 to-white">
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              <h2 className="text-2xl font-bold text-gray-800">Skills & Achievements</h2>
              <p className="text-gray-600">Professional certifications and skills</p>
            </div>
          </div>
        ...
        <div className="p-8">
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              ...
              <p className="text-gray-600">Upload required documents (Max 5MB each)</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-gradient-to-b from-white to-red-50 rounded-xl border border-red-200 p-6 shadow-sm hover:shadow-lg transition-shadow duration-300">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Aadhar, Passport, etc.</p>
                </div>
              </div>
              ...
              <div className="relative mb-4">
                <input
                  ...
                  accept="application/pdf,image/*"
                  onChange={(e) =>
                    formik.setFieldValue("idProofTrainer", e.currentTarget.files[0])
                  }
                  className="absolute inset-0 opacity-0 cursor-pointer z-20"
                />
              ...
              {trainerData?.idProofTrainer && !(formik.values.idProofTrainer instanceof File) && (
                <a
                  href={`${DIR.ID_PROOF_TRAINER}${trainerData.idProofTrainer}`}
                  target="_blank"
                  rel="noopener noreferrer"
            ...
            <div className="bg-gradient-to-b from-white to-blue-50 rounded-xl border border-blue-200 p-6 shadow-sm hover:shadow-lg transition-shadow duration-300">
              ...
              {trainerData?.resume && !(formik.values.resume instanceof File) && (
                <a
                  href={`${DIR.TRAINER_RESUME}${trainerData.resume}`}
                  target="_blank"
                  rel="noopener noreferrer"
            ...
            <div className="bg-gradient-to-b from-white to-purple-50 rounded-xl border border-purple-200 p-6 shadow-sm hover:shadow-lg transition-shadow duration-300">
              ...
              <div className="relative mb-4">
                <input
                  ...
                  accept="image/*"
                  onChange={(e) =>
                    formik.setFieldValue("profilePhotoTrainer", e.currentTarget.files[0])
                  }
                  className="absolute inset-0 opacity-0 cursor-pointer z-20"
                />
              ...
              <div className="flex justify-center mt-4">
                {formik.values.profilePhotoTrainer instanceof File ? (
                  ...
                  />
                ) : trainerData?.profilePhotoTrainer && trainerData.profilePhotoTrainer !== "null" ? (
                  <img
                    src={`${DIR.TRAINER_PROFILE_PHOTO}${trainerData.profilePhotoTrainer}`}
                    alt="Profile"
                    className="w-24 h-24 object-cover rounded-full border-4 border-white shadow-lg"
