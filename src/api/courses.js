...
// Get Courses List for student registration for dropdown
...
export const addNoteToCourse = async (courseId, formData, token) => {
  try {
    formData.append('course', courseId); // Ensure courseId is attached
